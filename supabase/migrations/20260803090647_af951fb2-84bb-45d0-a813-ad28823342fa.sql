...
GRANT EXECUTE ON FUNCTION public.is_label_owner(uuid, uuid) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.artist_user_id(uuid) TO authenticated;
...
GRANT SELECT (id, song_id, artist_id, role, accepted, created_at) ON public.song_collaborators TO anon;
...
GRANT EXECUTE ON FUNCTION public.is_song_collaborator(uuid, uuid) TO authenticated;
